...
},_moveElementToShowOutOfView:function(){this.view.moveOutOfSight();
...
},setVisible:function(c){if(c){this.view.show();
}else{this.view.hide();
...
}},onUrlChanged:function(){var h=this.ui.statusMessage;var g=this.ui.contentFrame;
...
},changeCommandButton:function(d,f,e){d.innerHTML=d.title=f;
$telerik.clearHandlers(d);
$telerik.addHandler(d,"click",this._preventDefault);
$telerik.addHandler(d,"click",e);
$addHandlers(d,{dblclick:this._cancelEvent,mousedown:this._cancelEvent},this);
...
}},onUrlChanged:function(){var i=this.ui.statusbar;
